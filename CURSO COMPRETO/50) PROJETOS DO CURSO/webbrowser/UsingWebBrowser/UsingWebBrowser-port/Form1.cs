...
#region WebBrowser2: HTML Document Viewer
        ...
        private void setupBrowser2()
        {
			...
			FileInfo fi = new FileInfo(@".." + Path.DirectorySeparatorChar + "README.htm");
...
#region WebBrowser3: 2-way Interaction 
        ...
        private void setupBrowser3()
        {
			...
			webBrowser3.DocumentStream = File.OpenRead(Path.GetDirectoryName(Application.ExecutablePath) + Path.DirectorySeparatorChar + ".." + Path.DirectorySeparatorChar + "SalesOrderForm.html");
		...
		{
			string projectPath = Path.GetDirectoryName(Application.ExecutablePath) + Path.DirectorySeparatorChar + ".." + Path.DirectorySeparatorChar;
			sales = new Sales();
